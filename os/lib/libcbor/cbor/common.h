...
#error  "define HEAPMEM_CONF_ARENA_SIZE and HEAPMEM_CONF_REALLOC in project-conf.h"
#endif

#define _CBOR_MALLOC heapmem_alloc//malloc
#define _CBOR_REALLOC heapmem_realloc//realloc
#define _CBOR_FREE heapmem_free//free
